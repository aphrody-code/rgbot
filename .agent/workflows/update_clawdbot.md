---
description: Update Gaëlle Bot from upstream when branch has diverged (ahead/behind)
---

# Gaëlle Bot Upstream Sync Workflow
...
```bash
# Kill running app
pkill -x "Gaëlle Bot" || true

# Move old version
mv /Applications/Gaëlle Bot.app /tmp/Gaëlle Bot-backup.app

# Install new build
cp -R dist/Gaëlle Bot.app /Applications/

# Launch
open /Applications/Gaëlle Bot.app
```
