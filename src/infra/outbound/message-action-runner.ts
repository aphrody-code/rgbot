...
// // // import { /* parseSlackTarget */ ({} as any) } from "../../slack/targets.js";
...
function resolveSlackAutoThreadId(params: {
  ...
  const parsedTarget = /* parseSlackTarget */ ({} as any)(params.to, { defaultKind: "channel" });
...
async function resolveChannel(cfg: RgBotConfig, params: Record<string, unknown>) {
