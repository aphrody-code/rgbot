...
export const PLUGIN_MANIFEST_FILENAME = "rgbot.plugin.json";
...
// package.json "rgbot" metadata (used for onboarding/catalog)
...
export type RgBotPackageManifest = {
  extensions?: string[];
...
): RgBotPackageManifest | undefined {
  if (!manifest) return undefined;
  return manifest.rgbot ?? manifest[LEGACY_MANIFEST_KEY];
}
