...
// Slack
type ListSlackDirectoryGroupsLive = any;
type ListSlackDirectoryPeersLive = any;
type ProbeSlack = any;
type ResolveSlackChannelAllowlist = any;
type ResolveSlackUserAllowlist = any;
type SendMessageSlack = any;
type MonitorSlackProvider = any;
type HandleSlackAction = any;
// Telegram
type AuditTelegramGroupMembership = any;
type CollectTelegramUnmentionedGroupIds = any;
type ProbeTelegram = any;
type ResolveTelegramToken = any;
type SendMessageTelegram = any;
type MonitorTelegramProvider = any;
type TelegramMessageActions = any;
// Signal
type ProbeSignal = any;
type SendMessageSignal = any;
type MonitorSignalProvider = any;
type SignalMessageActions = any;
// iMessage
type MonitorIMessageProvider = any;
type ProbeIMessage = any;
type SendMessageIMessage = any;
// WhatsApp
...
type HandleWhatsAppAction = any;
type CreateWhatsAppLoginTool =
  typeof import("../../channels/plugins/agent-tools/whatsapp-login.js").createWhatsAppLoginTool;

// LINE channel types
type ListLineAccountIds = any;
type ResolveDefaultLineAccountId = any;
type ResolveLineAccount = any;
type NormalizeLineAccountId = any;
type ProbeLineBot = any;
type SendMessageLine = any;
type PushMessageLine = any;
type PushMessagesLine = any;
type PushFlexMessage = any;
type PushTemplateMessage = any;
type PushLocationMessage = any;
type PushTextMessageWithQuickReplies = any;
type CreateQuickReplyItems = any;
type BuildTemplateMessageFromPayload = any;
type MonitorLineProvider = any;
