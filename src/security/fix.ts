...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof RgBotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: RgBotConfig; env: NodeJS.ProcessEnv }): {
  cfg: RgBotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
