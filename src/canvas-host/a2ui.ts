...
export const A2UI_PATH = "/__rgbot__/a2ui";
export const CANVAS_HOST_PATH = "/__rgbot__/canvas";
export const CANVAS_WS_PATH = "/__rgbot/ws";
...
(() => {
  ...
  const handlerNames = ["rgbotCanvasA2UIAction", "${legacyHandlerName}"];
  ...
  globalThis.RgBot = globalThis.RgBot ?? {};
  globalThis.RgBot.postMessage = postToNode;
  globalThis.RgBot.sendUserAction = sendUserAction;
  globalThis.rgbotPostMessage = postToNode;
  globalThis.rgbotSendUserAction = sendUserAction;
