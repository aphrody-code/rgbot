...
export const DEFAULT_SANDBOX_IMAGE = "rgbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "rgbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "rgbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "rgbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "rgbot-sbx-browser-";
