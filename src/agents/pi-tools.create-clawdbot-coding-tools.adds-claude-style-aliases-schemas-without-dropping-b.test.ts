...
describe("createRgBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createRgBotCodingTools({
      config,
    ...
    const anthropicTools = createRgBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createRgBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createRgBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
