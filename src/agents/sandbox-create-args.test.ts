  ...
  it("includes hardening and resource flags", () => {
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "rgbot.sandbox=1",
        "--label",
        "rgbot.sessionKey=main",
        "--label",
        "rgbot.createdAtMs=1700000000000",
        "--label",
        "rgbot.sandboxBrowser=1",
        "--read-only",
        "--tmpfs",
        "/tmp",
        "--network",
