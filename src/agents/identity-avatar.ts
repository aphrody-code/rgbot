...
function resolveAvatarSource(cfg: RgBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RgBotConfig, agentId: string): AgentAvatarResolution {
