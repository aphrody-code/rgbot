...
function resolveWatchPaths(workspaceDir: string, config?: RgBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RgBotConfig }) {
