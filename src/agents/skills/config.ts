...
import type { RgBotConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: RgBotConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: RgBotConfig | undefined, pathStr: string): boolean {
...
function isBundledSkill(entry: SkillEntry): boolean {
  return entry.skill.source === "rgbot-bundled";
}

export function resolveBundledAllowlist(config?: RgBotConfig): string[] | undefined {
