import type { BrowserConfig, BrowserProfileConfig, RgBotConfig } from "../config/config.js";
import {
 ...
 *
 * Note: this is a RgBot browser profile (routing config), not a Chrome user profile.
