...
import { type RgBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: RgBotConfig): string[] {
...
export function listAgentsForGateway(cfg: RgBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: RgBotConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: RgBotConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: RgBotConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: RgBotConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: RgBotConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: RgBotConfig): GatewaySessionsDefaults {
