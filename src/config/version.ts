...
export function parseRgBotVersion(raw: string | null | undefined): RgBotVersion | null {
  if (!raw) return null;
...
export function compareRgBotVersions(
  a: string | null | undefined,
  b: string | null | undefined,
): number | null {
  const parsedA = parseRgBotVersion(a);
  const parsedB = parseRgBotVersion(b);
