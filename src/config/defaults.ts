...
import type { RgBotConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: RgBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RgBotConfig): RgBotConfig {
...
export function applyTalkApiKey(config: RgBotConfig): RgBotConfig {
...
export function applyModelDefaults(cfg: RgBotConfig): RgBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RgBotConfig): RgBotConfig {
...
export function applyLoggingDefaults(cfg: RgBotConfig): RgBotConfig {
...
export function applyContextPruningDefaults(cfg: RgBotConfig): RgBotConfig {
...
export function applyCompactionDefaults(cfg: RgBotConfig): RgBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
