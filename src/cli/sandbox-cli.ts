...
const SANDBOX_EXAMPLES = {
  main: [
    ["rgbot sandbox list", "List all sandbox containers."],
    ["rgbot sandbox list --browser", "List only browser containers."],
    ["rgbot sandbox recreate --all", "Recreate all containers."],
    ["rgbot sandbox recreate --session main", "Recreate a specific session."],
    ["rgbot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["rgbot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["rgbot sandbox list", "List all sandbox containers."],
    ["rgbot sandbox list --browser", "List only browser containers."],
    ["rgbot sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["rgbot sandbox recreate --all", "Recreate all containers."],
    ["rgbot sandbox recreate --session main", "Recreate a specific session."],
    ["rgbot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["rgbot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["rgbot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["rgbot sandbox explain", "Show effective sandbox config."],
    ["rgbot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["rgbot sandbox explain --agent work", "Explain an agent sandbox."],
    ["rgbot sandbox explain --json", "JSON output."],
  ],
} as const;
