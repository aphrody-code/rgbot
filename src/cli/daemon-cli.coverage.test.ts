...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    process.env.CLAWDBOT_STATE_DIR = "/tmp/rgbot-cli-state";
    process.env.CLAWDBOT_CONFIG_PATH = "/tmp/rgbot-cli-state/rgbot.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        CLAWDBOT_STATE_DIR: "/tmp/rgbot-daemon-state",
        CLAWDBOT_CONFIG_PATH: "/tmp/rgbot-daemon-state/rgbot.json",
