...
${formatHelpExamples([
  ['rgbot agent --to +15555550123 --message "status update"', "Start a new session."],
  ['rgbot agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'rgbot agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'rgbot agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['rgbot agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
    'rgbot agent --agent ops --message "Generate report" --deliver --reply-channel slack --reply-to "#reports"',
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['rgbot agents set-identity --agent main --name "Clawd" --emoji "🦞"', "Set name + emoji."],
  ["rgbot agents set-identity --agent main --avatar avatars/clawd.png", "Set avatar path."],
  ["rgbot agents set-identity --workspace ~/clawd --from-identity", "Load from IDENTITY.md."],
  [
    "rgbot agents set-identity --identity-file ~/clawd/IDENTITY.md --agent main",
