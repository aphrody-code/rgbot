...
function resolveMentionPatterns(cfg: RgBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: RgBotConfig | undefined, agentId?: string): RegExp[] {
