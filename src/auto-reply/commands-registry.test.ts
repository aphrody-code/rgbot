...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@rgbot", { botUsername: "rgbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@rgbot args", {
        botUsername: "rgbot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "rgbot" })).toBe(
      "/help@otherbot",
    );
  });
