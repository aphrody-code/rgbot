...
export function listBindings(cfg: RgBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: RgBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: RgBotConfig) {
