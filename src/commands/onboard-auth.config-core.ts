...
export function applyZaiConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applyOpenrouterProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applyOpenrouterConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applyMoonshotProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applyKimiCodeProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applySyntheticProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: RgBotConfig): RgBotConfig {
...
export function applyXiaomiProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: RgBotConfig): RgBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: RgBotConfig): RgBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: RgBotConfig): RgBotConfig {
