...
// // // import { /* fetchSlackScopes */ (async () => ({} as any)), type SlackScopesResult } from "../../slack/scopes.js";
...
const _TEAMS_GRAPH_PERMISSION_HINTS: Record<string, string> = {
