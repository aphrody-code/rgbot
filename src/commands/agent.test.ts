...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "rgbot-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<RgBotConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<RgBotConfig["telegram"]>>,
