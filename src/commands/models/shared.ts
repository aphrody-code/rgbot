...
export async function updateConfig(
  mutator: (cfg: RgBotConfig) => RgBotConfig,
): Promise<RgBotConfig> {
...
export function resolveModelTarget(params: { raw: string; cfg: RgBotConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: RgBotConfig): Set<string> {
