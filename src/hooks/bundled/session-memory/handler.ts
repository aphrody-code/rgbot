...
const saveSessionToMemory: HookHandler = async (event) => {
  ...
  try {
    ...
    const cfg = context.cfg as RgBotConfig | undefined;
    ...
    if (sessionFile) {
      ...
      if (sessionContent && cfg) {
        ...
        const rgbotRoot = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
        const slugGenPath = path.join(rgbotRoot, "llm-slug-generator.js");
