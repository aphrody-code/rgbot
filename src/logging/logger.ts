...
export const DEFAULT_LOG_DIR = "/tmp/rgbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "rgbot.log"); // legacy single-file path

const LOG_PREFIX = "rgbot";
...
function resolveSettings(): ResolvedSettings {
  let cfg: RgBotConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => RgBotConfig;
      };
