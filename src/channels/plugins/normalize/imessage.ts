// // // import { /* normalizeIMessageHandle */ ((s:string)=>s) } from "../../../imessage/targets.js";
...
export function normalizeIMessageMessagingTarget(raw: string): string | undefined {
  ...
  for (const prefix of SERVICE_PREFIXES) {
    if (lower.startsWith(prefix)) {
      ...
      const normalizedHandle = /* normalizeIMessageHandle */ ((s:string)=>s)(remainder);
  ...
  const normalized = /* normalizeIMessageHandle */ ((s:string)=>s)(trimmed);
