...
export function listChannelMessageActions(cfg: RgBotConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: RgBotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: RgBotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
