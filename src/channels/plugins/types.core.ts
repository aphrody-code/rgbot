...
export type ChannelAgentToolFactory = (params: { cfg?: RgBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: RgBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: RgBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: RgBotConfig }) => boolean;
  supportsCards?: (params: { cfg: RgBotConfig }) => boolean;
