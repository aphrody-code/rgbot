...
show_usage() {
    cat << EOF
clawlog - Rose Griffon Bot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Rose Griffon Bot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Rose Griffon Bot logs flow through the macOS unified log (subsystem: bot.molt).
