...
export CLAWDBOT_STATE_DIR="/tmp/rgbot-test"
export CLAWDBOT_CONFIG_PATH="${CLAWDBOT_STATE_DIR}/rgbot.json"
...
pnpm rgbot reset --scope config+creds+sessions --yes --non-interactive
...
pnpm rgbot uninstall --state --yes --non-interactive
