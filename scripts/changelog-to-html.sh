...
if [[ -z "$version_content" ]]; then
  echo "<h2>Rose Griffon Bot $VERSION</h2>"
  echo "<p>Latest Rose Griffon Bot update.</p>"
  echo "<p><a href=\"https://github.com/rgbot/rgbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
