...
function setMSTeamsDmPolicy(cfg: Rose Griffon BotConfig, dmPolicy: DmPolicy) {
  const allowFrom =
    dmPolicy === "open"
...
function setMSTeamsAllowFrom(cfg: Rose Griffon BotConfig, allowFrom: string[]): Rose Griffon BotConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
