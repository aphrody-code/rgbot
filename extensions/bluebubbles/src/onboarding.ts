...
function setBlueBubblesDmPolicy(cfg: Rose Griffon BotConfig, dmPolicy: DmPolicy): Rose Griffon BotConfig {
  const allowFrom =
  ...
  configure: async ({ cfg, prompter, accountOverrides, shouldPromptAccountIds }) => {
    ...
    await prompter.note(
      [
        ...
        "2. Add your Rose Griffon Bot gateway URL + webhook path",
