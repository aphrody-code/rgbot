...
export function resolveTlonAccount(cfg: Rose Griffon BotConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: Rose Griffon BotConfig): string[] {
  const base = cfg.channels?.tlon as
