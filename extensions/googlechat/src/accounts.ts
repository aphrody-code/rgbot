...
export function listGoogleChatAccountIds(cfg: Rose Griffon BotConfig): string[] {
  const ids = listConfiguredAccountIds(cfg);
  if (ids.length === 0) return [DEFAULT_ACCOUNT_ID];
  return ids.sort((a, b) => a.localeCompare(b));
}

export function resolveDefaultGoogleChatAccountId(cfg: Rose Griffon BotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: Rose Griffon BotConfig): ResolvedGoogleChatAccount[] {
