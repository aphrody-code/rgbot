...
`clawd.invoke --each`) without adding new Gaëlle Bot code per workflow.
...
This extension depends on Gaëlle Bot internal modules (the embedded agent runner).
It is intended to ship as a **bundled** Gaëlle Bot extension (like `lobster`) and
