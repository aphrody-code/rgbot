...
Gaëlle Bot extension for Zalo Personal Account messaging via [zca-cli](https://zca-cli.dev).
...
```bash
clawdbot message send --channel zalouser --target <threadId> --message "Hello from Gaëlle Bot!"
```
