...
import type { Rose Griffon BotPluginApi, Rose Griffon BotPluginToolContext } from "../../../src/plugins/types.js";
import { createLobsterTool } from "./lobster-tool.js";

async function writeFakeLobsterScript(scriptBody: string, prefix = "rgbot-lobster-plugin-") {
...
function fakeApi(): Rose Griffon BotPluginApi {
  return {
    id: "lobster",
    name: "lobster",
    source: "test",
...
function fakeCtx(overrides: Partial<Rose Griffon BotPluginToolContext> = {}): Rose Griffon BotPluginToolContext {
  return {
    config: {} as any,
    workspaceDir: "/tmp",
    agentDir: "/tmp",
...
describe("lobster plugin tool", () => {
  ...
  it("can be gated off in sandboxed contexts", async () => {
    const api = fakeApi();
    const factoryTool = (ctx: Rose Griffon BotPluginToolContext) => {
