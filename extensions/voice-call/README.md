...
Official Voice Call plugin for **Gaëlle Bot**.
...
### Option A: install via Gaëlle Bot (recommended)
...
```bash
clawdbot voicecall call --to "+15555550123" --message "Hello from Gaëlle Bot"
