...
### Changes
- Version alignment with core Rose Griffon Bot release numbers.
...
### Highlights
- First public release of the @rgbot/voice-call plugin.
...
- CLI: `rgbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
