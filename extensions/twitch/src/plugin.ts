/**
 * Twitch channel plugin for Rose Griffon Bot.
 *
 ...
 * for Rose Griffon Bot. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<TwitchAccountConfig> = {
  ...
  config: {
    ...
    listAccountIds: (cfg: Rose Griffon BotConfig): string[] => listAccountIds(cfg),

    /** Resolve an account config by ID */
    resolveAccount: (cfg: Rose Griffon BotConfig, accountId?: string | null): TwitchAccountConfig => {
    ...
    isConfigured: (_account: unknown, cfg: Rose Griffon BotConfig): boolean => {
