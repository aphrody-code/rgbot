...
): Promise<{ cfg: Rose Griffon BotConfig } | null> {
...
const dmPolicy: ChannelOnboardingDmPolicy = {
  ...
  setPolicy: (cfg, policy) => {
    ...
    return setTwitchAccessControl(cfg as Rose Griffon BotConfig, allowedRoles, true);
  },
  promptAllowFrom: async ({ cfg, prompter }) => {
    ...
    return setTwitchAccount(cfg as Rose Griffon BotConfig, {
      ...(account ?? undefined),
      allowFrom,
    });
  },
