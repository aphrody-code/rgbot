...
import type { ReplyPayload, Rose Griffon BotConfig } from "clawdbot/plugin-sdk";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // Rose Griffon BotConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as Rose Griffon BotConfig;
